...
- [urls](#urls) - urls to download, _required_
- [directory](#directory) - path to save files, _required_
...
class MyPlugin {
  apply(registerAction) {
    ...
    registerAction(
      'getReference',
      async ({ resource, parentResource, originalReference }) => {}
    );
  }
}
...
registerAction(
  ...
  ({ resource, parentResource, originalReference }) => {
    ...
    return {
      reference: utils.getRelativePath(
